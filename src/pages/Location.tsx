...
const Location = () => {
  ...
  const currentProperties = forRentProperties.slice(
    ...
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 flex-wrap gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold mb-2">Propriétés à Louer</h1>
            <p className="text-gray-500">
              {forRentProperties.length} résultats trouvés • Page {currentPage} sur {totalPages}
            </p>
          </div>
        ...
        {forRentProperties.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12">
            <Alert className="max-w-md">
              ...
              <AlertDescription>
                Aucune propriété à louer ne correspond à vos critères de recherche.
              </AlertDescription>
            </Alert>
          </div>
        ) : (
        ...
        {forRentProperties.length > 0 && (
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-gray-500 mb-4 sm:mb-0">
              Affichage de {(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, forRentProperties.length)} sur {forRentProperties.length} résultats
            </p>
