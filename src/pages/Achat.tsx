...
const Achat = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState<Parcel[]>([]);
  ...
  useEffect(() => {
    ...
    // On récupère uniquement les propriétés à vendre
    let filtered = parcelsData.filter(property => property.forSale === true);
    ...
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="container mx-auto px-4 py-8">
        <PropertyFilters 
          ...
          searchPlaceholder="Rechercher une propriété à vendre..."
        />
